...
CREATE TABLE `exam_manage`  (
  ...
  INDEX `idx_teacher`(`teacherId`) USING BTREE,
  INDEX `idx_course`(`courseId`) USING BTREE
...
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20230001, '2025年12月期末考试', '计算机网络', 1001, '2025-12-15', 90, '2025', '1', '计算机科学与技术', '软件工程学院', 86, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081001, 1);
INSERT INTO `exam_manage` VALUES (20230002, '2025年12月期末考试', '数据库理论', 1002, '2025-12-10', 90, '2025', '2', '网络工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081001, 2);
INSERT INTO `exam_manage` VALUES (20230003, '2025年12月期末考试', '数据结构', 1003, '2025-12-08', 90, '2025', '1', '软件工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081001, 3);
INSERT INTO `exam_manage` VALUES (20230005, '2025年12月期末考试', '计算机导论', 1004, '2025-12-12', 90, '2025', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081002, 4);
INSERT INTO `exam_manage` VALUES (20230006, '2025年12月期末考试', '软件工程', 1005, '2025-12-15', 120, '2025', '1', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081002, 5);
INSERT INTO `exam_manage` VALUES (20230007, '2025年12月期末考试', '操作系统', 1006, '2025-12-11', 120, '2025', '2', '计算机科学与技术', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081002, 6);
INSERT INTO `exam_manage` VALUES (20230008, '2025年12月期末考试', 'C语言', 1007, '2025-12-11', 120, '2025', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081003, 7);
INSERT INTO `exam_manage` VALUES (20230009, '2025年12月期末考试', '高等数学', 1008, '2025-12-10', 90, '2025', '1', '信息工程', '软件工程学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。', 20081005, 8);
INSERT INTO `exam_manage` VALUES (20230013, '测试', '测试', 1009, '2025-12-20', 120, '2025', NULL, '测试', '测试', 100, '期末考试', '请不要带与考试无关的书籍。', NULL, NULL);
INSERT INTO `exam_manage` VALUES (20230014, 'Java程序设计', 'Java程序设计', 1010, '2025-12-05', 60, '2025', NULL, '软件工程', '计算机学院', 100, '期末考试', '请规范作答', 20081003, 9);
INSERT INTO `exam_manage` VALUES (20230015, '考试', 'C#', 1011, '2025-12-11', 5, '2025', NULL, '软件工程', '计算机学院', 30, '期末考', '请规范作答2', 20081005, 10);
INSERT INTO `exam_manage` VALUES (20230016, '高等数学考试', '高等数学', 1012, '2025-12-14', 90, '2025', NULL, '数学工程', '数学院', NULL, '期末考试', NULL, NULL, NULL);
INSERT INTO `exam_manage` VALUES (20230017, '程序测试', '计算机网络', 1013, '2025-12-15', 90, '2025', NULL, '软件工程', '计算机学院', 0, '期末', NULL, 20081001, 1);
INSERT INTO `exam_manage` VALUES (20230018, '333', '333', 1014, '2025-12-16', 90, '2025', NULL, '333', '333', NULL, '333', '333', NULL, NULL);
INSERT INTO `exam_manage` VALUES (20230024, '测试', '计算机网络', 1015, '2025-12-18', 90, '2025', NULL, '网络工程', '计算机学院', NULL, '期中测试', '沉着应试', 20081001, 1);
INSERT INTO `exam_manage` VALUES (20230025, '测试', '测试', 1016, '2025-12-18', 90, '测试', NULL, '测试', '测试', NULL, '测试', '测试', NULL, NULL);
INSERT INTO `exam_manage` VALUES (20230026, '测试', '测试2', 1017, '2025-12-18', 90, '测试', NULL, '测试', '测试', NULL, '测试', '测试', NULL, NULL);
INSERT INTO `exam_manage` VALUES (20230027, '测试', '测试3', 1018, '2025-12-18', 90, '测试', NULL, '测试', '测试', NULL, '测试', '测试', NULL, NULL);
...
-- Records of message
-- ----------------------------
INSERT INTO `message` VALUES (37, '张三', '计算机网络考试好难', '2025-12-10');
INSERT INTO `message` VALUES (38, '李四', '练习了很多遍还是很难', '2025-12-10');
...
-- Records of replay
-- ----------------------------
INSERT INTO `replay` VALUES (37, 22, '真的难', '2025-12-10');
INSERT INTO `replay` VALUES (37, 23, '同感', '2025-12-10');
...
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (153, 20190024, 20224084, '计算机网络', 1, 12, 18, '2025-12-18');
INSERT INTO `score` VALUES (154, 20230001, 20224084, '计算机网络', 0, 6, 86, '2025-12-18');
...
-- ----------------------------
-- Table structure for page_switch_record
-- ----------------------------
DROP TABLE IF EXISTS `page_switch_record`;
CREATE TABLE `page_switch_record`  (
  `recordId` int(0) NOT NULL AUTO_INCREMENT COMMENT '记录编号',
  `examCode` int(0) NULL DEFAULT NULL COMMENT '考试编号',
  `studentId` int(0) NULL DEFAULT NULL COMMENT '学号',
  `switchTime` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '切换时间',
  `switchType` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '切换类型：tab_switch(切换标签页), window_blur(窗口失焦), page_leave(离开页面)',
  `duration` int(0) NULL DEFAULT NULL COMMENT '离开时长（秒）',
  `returnTime` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '返回时间',
  PRIMARY KEY (`recordId`) USING BTREE,
  INDEX `idx_exam_student`(`examCode`, `studentId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '页面切换记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course`  (
  `courseId` int(0) NOT NULL AUTO_INCREMENT COMMENT '课程编号',
  `courseName` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '课程名称',
  `courseCode` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '课程代码',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '课程描述',
  `credits` int(0) NULL DEFAULT NULL COMMENT '学分',
  `institute` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '所属学院',
  PRIMARY KEY (`courseId`) USING BTREE,
  UNIQUE INDEX `uk_course_code`(`courseCode`) USING BTREE
...
CREATE TABLE `teacher_course`  (
  ...
  `courseId` int(0) NULL DEFAULT NULL COMMENT '课程ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_teacher_course`(`teacherId`, `courseId`) USING BTREE,
  INDEX `idx_teacher`(`teacherId`) USING BTREE,
  INDEX `idx_course`(`courseId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '教师课程关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `student_course`  (
  ...
  `courseId` int(0) NULL DEFAULT NULL COMMENT '课程ID',
  `teacherId` int(0) NULL DEFAULT NULL COMMENT '教师ID',
  `selectTime` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '选课时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_student_course`(`studentId`, `courseId`) USING BTREE,
  INDEX `idx_student`(`studentId`) USING BTREE,
  INDEX `idx_course`(`courseId`) USING BTREE,
  INDEX `idx_teacher`(`teacherId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '学生选课表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of course
-- ----------------------------
INSERT INTO `course` VALUES (1, '计算机网络', 'CS001', '计算机网络基础课程，涵盖网络协议、网络架构等内容', 3, '软件工程学院');
INSERT INTO `course` VALUES (2, '数据库理论', 'CS002', '数据库系统原理与设计', 3, '软件工程学院');
INSERT INTO `course` VALUES (3, '数据结构', 'CS003', '数据结构与算法分析', 4, '软件工程学院');
INSERT INTO `course` VALUES (4, '计算机导论', 'CS004', '计算机科学导论', 2, '软件工程学院');
INSERT INTO `course` VALUES (5, '软件工程', 'CS005', '软件工程原理与实践', 3, '软件工程学院');
INSERT INTO `course` VALUES (6, '操作系统', 'CS006', '操作系统原理与设计', 4, '软件工程学院');
INSERT INTO `course` VALUES (7, 'C语言', 'CS007', 'C语言程序设计', 3, '软件工程学院');
INSERT INTO `course` VALUES (8, '高等数学', 'MATH001', '高等数学基础', 4, '软件工程学院');
INSERT INTO `course` VALUES (9, 'Java程序设计', 'CS008', 'Java面向对象程序设计', 3, '计算机学院');
INSERT INTO `course` VALUES (10, 'C#', 'CS009', 'C#程序设计', 3, '计算机学院');

-- ----------------------------
-- Records of teacher_course
-- ----------------------------
-- 张小风(20081001)教授的课程
INSERT INTO `teacher_course` VALUES (1, 20081001, 1); -- 计算机网络
INSERT INTO `teacher_course` VALUES (2, 20081001, 2); -- 数据库理论
INSERT INTO `teacher_course` VALUES (3, 20081001, 3); -- 数据结构

-- 王大志(20081002)教授的课程
INSERT INTO `teacher_course` VALUES (4, 20081002, 4); -- 计算机导论
INSERT INTO `teacher_course` VALUES (5, 20081002, 5); -- 软件工程
INSERT INTO `teacher_course` VALUES (6, 20081002, 6); -- 操作系统

-- 李四(20081003)教授的课程
INSERT INTO `teacher_course` VALUES (7, 20081003, 7); -- C语言
INSERT INTO `teacher_course` VALUES (8, 20081003, 9); -- Java程序设计

-- 李白(20081005)教授的课程
INSERT INTO `teacher_course` VALUES (9, 20081005, 8); -- 高等数学
INSERT INTO `teacher_course` VALUES (10, 20081005, 10); -- C#

-- ----------------------------
-- Records of student_course
-- ----------------------------
-- 王六(20224001)选课
INSERT INTO `student_course` VALUES (1, 20224001, 1, 20081001, '2025-12-01 10:00:00'); -- 计算机网络-张小风
INSERT INTO `student_course` VALUES (2, 20224001, 2, 20081001, '2025-12-01 10:05:00'); -- 数据库理论-张小风
INSERT INTO `student_course` VALUES (3, 20224001, 4, 20081002, '2025-12-01 10:10:00'); -- 计算机导论-王大志

-- 张三(20224084)选课
INSERT INTO `student_course` VALUES (4, 20224084, 1, 20081001, '2025-12-01 11:00:00'); -- 计算机网络-张小风
INSERT INTO `student_course` VALUES (5, 20224084, 3, 20081001, '2025-12-01 11:05:00'); -- 数据结构-张小风
INSERT INTO `student_course` VALUES (6, 20224084, 5, 20081002, '2025-12-01 11:10:00'); -- 软件工程-王大志

-- 李四(20225003)选课
INSERT INTO `student_course` VALUES (7, 20225003, 6, 20081002, '2025-12-01 12:00:00'); -- 操作系统-王大志
INSERT INTO `student_course` VALUES (8, 20225003, 7, 20081003, '2025-12-01 12:05:00'); -- C语言-李四
INSERT INTO `student_course` VALUES (9, 20225003, 8, 20081005, '2025-12-01 12:10:00'); -- 高等数学-李白

-- 王五(20225007)选课
INSERT INTO `student_course` VALUES (10, 20225007, 1, 20081001, '2025-12-01 13:00:00'); -- 计算机网络-张小风
INSERT INTO `student_course` VALUES (11, 20225007, 9, 20081003, '2025-12-01 13:05:00'); -- Java程序设计-李四

-- 徐七(20225008)选课
INSERT INTO `student_course` VALUES (12, 20225008, 2, 20081001, '2025-12-01 14:00:00'); -- 数据库理论-张小风
INSERT INTO `student_course` VALUES (13, 20225008, 4, 20081002, '2025-12-01 14:05:00'); -- 计算机导论-王大志
INSERT INTO `student_course` VALUES (14, 20225008, 10, 20081005, '2025-12-01 14:10:00'); -- C#-李白

-- 郑八(20225009)选课
INSERT INTO `student_course` VALUES (15, 20225009, 3, 20081001, '2025-12-01 15:00:00'); -- 数据结构-张小风
INSERT INTO `student_course` VALUES (16, 20225009, 5, 20081002, '2025-12-01 15:05:00'); -- 软件工程-王大志
INSERT INTO `student_course` VALUES (17, 20225009, 9, 20081003, '2025-12-01 15:10:00'); -- Java程序设计-李四
